...
namespace SoLoud
{
	...
	// DirectSound back-end initialization call
	result dsound_init(SoLoud::Soloud * aSoloud, unsigned int aFlags = Soloud::CLIP_ROUNDOFF, unsigned int aSamplerate = 44100, unsigned int aBuffer = 2048, unsigned int aChannels = 2);
